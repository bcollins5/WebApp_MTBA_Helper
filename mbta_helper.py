...
def get_json(url):
    ...
    """
    Set "f", the file, equal to the information from the URL. Read the
    file and return the information in a nicely-formatted JSON display.
    """
...
def get_lat_long(place_name):
    ...
    """
    If a space is entered in the input, replace the space with "%20"
    so that the input can be properly added to the URL. Return the
    latitude and longitude from the outputted results generated from
